        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:items-center lg:py-28">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border bg-background/80 px-3 py-1 text-sm font-medium">
              <BadgeCheck className="size-4 text-emerald-600" /> Trusted local
              providers
            </span>
            <h1 className="mt-6 text-5xl font-black leading-[1.05] tracking-tight sm:text-6xl">
              Adventure-ready gear,{" "}
              <span className="text-primary">without the storage.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/gear"
                className="inline-flex h-11 items-center gap-2 rounded-lg bg-primary px-5 font-medium text-primary-foreground"
              >
                Explore gear <ArrowRight className="size-4" />
              </Link>
              <Link
                href="/auth/register"
                className="inline-flex h-11 items-center rounded-lg border bg-background px-5 font-medium"
              >
                List your equipment
              </Link>
            </div>
