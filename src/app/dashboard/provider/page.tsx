...
export default function ProviderDashboardPage() {
  ...
  const orders = useQuery({
    queryKey: [...queryKeys.providerOrders, { limit: 100 }],
  ...
  return (
    <div className="space-y-8">
      ...
      />
      <ProviderStats gear={gear.data ?? []} orders={orders.data?.items ?? []} />
      <section>
        <h2 className="mb-4 text-xl font-semibold">Recent incoming orders</h2>
