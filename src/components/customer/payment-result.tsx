...
const content = {
  success: {
    ...
    description:
      "Your transaction was completed. The rental status may take a moment to update.",
  ...
  cancel: {
    ...
    description:
      "No completed payment was recorded. You can return to the order and try again.",
  ...
  fail: {
    ...
    description:
      "The gateway could not complete the transaction. Please try again or use another payment method.",
  ...
  return (
    <main className="mx-auto flex w-full max-w-lg flex-1 items-center px-4 py-20">
      <section className="w-full rounded-3xl border bg-card p-8 text-center shadow-sm">
        <Icon className={`mx-auto size-14 ${style}`} />
